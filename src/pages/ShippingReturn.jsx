    ...
    <div className="page-container section-padding">
      <div className="container">
        ...
        <div className="policy-content" style={{ maxWidth: '900px', margin: '0 auto', lineHeight: '1.8' }}>
          ...
          <br />
          <p>Thank you for choosing JERKEIS, a brand under AGRANEX INDUSTRIES PRIVATE LIMITED. To provide you with the most reliable logistics and customer support, we utilize established third-party marketplaces for all order fulfillment.</p>

          <h3 id="shipping">1. ORDER FULFILLMENT & SHIPPING</h3>
          <p><strong>Third-Party Logistics:</strong> JERKEIS does not ship products directly. All orders are fulfilled, managed, and shipped by our authorized third-party partners, including Amazon, Flipkart, and Meesho.</p>
          ...
          <ul>
            <li><strong>Brand:</strong> JERKEIS</li>
            <li><strong>Parent Company:</strong> AGRANEX INDUSTRIES PRIVATE LIMITED</li>
            <li><strong>Email:</strong> support@jerkeis.com</li>
          </ul>
          <p><em>Please Note: JERKEIS hosts product information on our website for your convenience, but the final purchase agreement and logistical handling are conducted solely through our third-party channel partners.</em></p>
        </div>
      </div>
    </div>
  )
