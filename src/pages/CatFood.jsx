    ...
    <div className="page-container section-padding">
      <div className="container">
        <div className="text-center" style={{marginBottom: '60px'}}>
          <h1 style={{fontSize: '3.5rem', marginBottom: '20px'}}>Gourmet <span className="highlight" style={{color: 'var(--primary)'}}>Cat Food</span></h1>
          <p style={{color: 'var(--text-muted)', fontSize: '1.2rem'}}>The finest ingredients for your feline companion.</p>
        </div>
